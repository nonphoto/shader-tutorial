...
.then(([vertexSource, fragmentSource]) => {
	...
	// Get the memory location allocated to our time uniform.
	const timeUniform = gl.getUniformLocation(program, 'u_time')

	/**
	 * Handle animation frame callbacks.
	 */
	function draw(t) {

		// Write the current time to the location provided by our time uniform.
	...
	// Start the animation frame loop at the current time.
